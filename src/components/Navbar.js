  ...
  return (
    <div className='flex justify-between p-2 md:mx-6 relative'>
      ...
      <TooltipComponent content="profile" position='TopLeft'>
        <div className='flex items-center gap-2 p-1 hover:bg-light-gray rounded-lg' onClick={()=>handleClick('userProfile')}>
          <img className='rounded-full w-8 h-8 ' src={avatar}/>
          <p>
            <span className='text-gray-400 text-14'>Hi,</span>{' '}
            <span className='text-gray-400 ml-1 text-14'>Kanha</span>
